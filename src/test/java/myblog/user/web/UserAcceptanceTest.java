...
public class UserAcceptanceTest extends AcceptanceTest {
    ...
    void crud() {
        // 회원가입
        UserCreatedDto expected = new UserCreatedDto(createUserId(), "javajigi@nextstep.camp", "password");
    ...
    void update_when_other_user() {
        UserCreatedDto original = new UserCreatedDto(createUserId(), "javajigi@nextstep.camp", "password");
        URI location = createUser(original);

        UserCreatedDto otherUser = new UserCreatedDto(createUserId(), "sanjigi@nextstep.camp", "password");
